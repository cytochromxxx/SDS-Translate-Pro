        ...
        try:
            ...
            for page_idx in range(8, 12):
                ...
                for table in tables:
                    ...
                    # If we found a block of abbreviations, add them
                    if len(valid_rows) >= 3:
            ...
            m = re.search(r'16\.2\.?[^\n]*?Abbreviation[^\n]*\n(.*?)(?=16\.3|For abbreviation|\Z)', text, re.DOTALL | re.IGNORECASE)
            if m and not abbreviations:
                ...
                for i, line in enumerate(lines):
                    ...
                    if len(parts) == 2:
                        ...
                        if _is_valid_abbrev(short) and len(long) > 3:
                            abbreviations.append({"short": short, "long": long})
                            continue
                    ...
                    if len(parts) == 1 and _is_valid_abbrev(line):
                        if i + 1 < len(lines):
                            ...
                            if len(next_line) > 3 and not _is_valid_abbrev(next_line.split(' ')[0]):
